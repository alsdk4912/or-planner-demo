  ...
  return (
    <div className="h-[100dvh] overflow-hidden bg-[var(--app-bg)]">
      <main className="mx-auto flex h-[calc(100dvh-64px)] w-full max-w-[420px] flex-col gap-2 px-3 py-3">
        ...
        <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-2 shadow-[0_4px_14px_rgba(16,185,129,0.12)]">
          <p className="text-center text-[11px] font-semibold text-emerald-800">AI가 해결한 오늘 세 건의 위험</p>
          <div className="mt-1 space-y-1">
            <p className="rounded-lg bg-white px-2 py-1 text-[11px] text-emerald-800">멸균 만료 물품 1건 차단</p>
            <p className="rounded-lg bg-white px-2 py-1 text-[11px] text-emerald-800">신규 간호사 매뉴얼 누락 2건 방지</p>
            <p className="rounded-lg bg-white px-2 py-1 text-[11px] text-emerald-800">체크리스트 단계 차단 1건 사전 해소</p>
          </div>
        </section>
